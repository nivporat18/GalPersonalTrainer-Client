...
<section className="fixed  justify-center overflow-hidden bg-[url(https://res.cloudinary.com/mepelaozen/image/upload/v1686810065/GalWeb/gym_background_t0tg5v.jpg)] bg-cover  bg-no-repeat mt-8">
