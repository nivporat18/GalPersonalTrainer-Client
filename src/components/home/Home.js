...
<section className="flex justify-center overflow-hidden bg-[url(https://res.cloudinary.com/mepelaozen/image/upload/v1686810065/GalWeb/gym_background_t0tg5v.jpg)] min-h-screen bg-cover bg-no-repeat bg-fixed ">
